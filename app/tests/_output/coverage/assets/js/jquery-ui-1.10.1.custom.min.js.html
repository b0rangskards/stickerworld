...
<html lang="en">
 <head>
  <meta charset="UTF-8">
  <title>Code Coverage for C:\wamp\www\stickerworld\app/assets/js/jquery-ui-1.10.1.custom.min.js</title>
    ...
    <div class="row">
     <div class="col-md-12">
      <ol class="breadcrumb">
        ...
        <li class="active">jquery-ui-1.10.1.custom.min.js</li>
