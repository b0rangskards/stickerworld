(function(global, document) {
  ...
  // Popcorn.scripts does not support archaic browsers
    ...
    init: function( entity, options ) {
      ...
      if ( typeof entity === "string" ) {
        try {
          ...
          throw new Error( "Popcorn.scripts Error: Invalid media element selector: " + entity );
        }
      }
      ...
      if ( Popcorn.byId( this.id ) ) {
        throw new Error( "Popcorn.scripts Error: Cannot use duplicate ID (" + this.id + ")" );
      }
