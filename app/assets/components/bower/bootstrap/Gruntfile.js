...
module.exports = function (grunt) {
  ...
  if (runSubset('core') &&
    ...
    testSubtasks = testSubtasks.concat(['dist-styles', 'dist-scripts', 'csslint:dist', 'test-scripts', 'docs']);
  }
  ...
  grunt.registerTask('dist', ['clean:dist', 'dist-styles', 'copy:fonts', 'dist-scripts']);
  ...
  grunt.registerTask('docs', ['docs-styles', 'lint-docs-styles', 'docs-scripts', 'lint-docs-scripts', 'clean:docs', 'copy:docs', 'build-glyphicons-data', 'build-customizer']);
