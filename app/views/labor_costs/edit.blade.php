            ...
            <section class="panel">
                ...
                @include('flash::message')
                    ...
                    <div class="row">
                        ...
                        <div class="form">
                            {{ Form::open(['route' => ['update_labor_cost_path', $laborcost->id],
                                           'method' => 'PUT',
                                 ...
                                 <div class="form-group {{!$errors->has('type') ?:'has-error'}}">
                                      ...
                                      <div class="col-md-4">
                                          {{ Form::text('type', $laborcost->type, ['class' => 'form-control']) }}
                               ...
                               <div class="form-group {{!$errors->has('rate') ?:'has-error'}}">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::text('rate', $laborcost->rate, ['class' => 'form-control']) }}
                               ...
                               <div class="form-group {{!$errors->has('remarks') ?:'has-error'}}">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::textarea('remarks', $laborcost->remarks, ['class' => 'form-control', 'rows' => '4', 'placeholder' => 'This is Optional']) }}
                               ...
                               <hr/>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-4 col-md-6">
                                        {{ Form::submit('Update Labor Cost', ['class' => 'btn btn-primary']) }}
