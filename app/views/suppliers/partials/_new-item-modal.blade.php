    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                     <div class="col-md-12">
                        {{ Form::open(['route' => ['create_item_path', $supplier->id],
                          'id'      => 'new-item-form',
                          ...
                          'data-form-files-remote']) }}
                            ...
                            <div class="form-group">
                                {{ Form::label('is_sm', 'Is This a Standard Material?', ['class' => 'col-md-3 control-label']) }}
                                <div class="col-md-6">
                                    <div class="flat-grey single-row">
                                        <div class="radio ">
                                            <input type="checkbox" name="is_sm" value="1" {{Input::old('is_sm')}}>
                                        </div>
                                    </div>
                                </div>
                            </div>
