<div class="modal fade modal-form" id="addStandardMaterialModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Add Standard Material</h4>
            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="action">
                                        <div class="input-group m-bot15">
                                            ...
                                            <input type="text" name="item" id="search-project-standard-item" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="price">
                                        ...
                                        <input type="number" min="0" class="item-project-qty form-control" id="qty-proj-sm"/> <span class="label">QTY</span>
                                        <p>Total</p>
                                    </div>
                                </div>
